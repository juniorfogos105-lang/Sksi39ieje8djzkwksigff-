local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/matheuzxs/RedzlibV5Modify/refs/heads/main/MelhorQueFluent"))()

local Window = redzlib:MakeWindow({
    Title = "Doutor Hub - Brookhaven RP🏡",
    SubTitle = "by: DoutorNeo",
  })

  Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://96233392646220", BackgroundTransparency = 0 },
...
local Section = Tab1:AddSection({"Versão: 0.1"})

local Paragraph = Tab1:AddParagraph({"Criadores", "nomi & Max"})
